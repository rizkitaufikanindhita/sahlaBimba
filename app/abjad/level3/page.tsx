...
const Level3 = () => {
  ...
  <div className="absolute top-0 z-[-2] h-screen w-screen bg-[#000000] bg-[radial-gradient(#ffffff66_1px,#1E293B_1px)] bg-[size:20px_20px]">
      <div className="flex justify-center items-center h-screen">
        <div className="w-[350px] h-fit md:w-[600px] xl:w-[400px] rounded-xl bg-slate-600 ">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m2.25 12 8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
          ...
          <div className="flex justify-center items-center p-5 text-slate-300 text-md md:text-xl">ABJAD Lv3</div>
          <div className="flex justify-center items-center pb-10 font-bold text-[300px] md:text-[400px] xl:text-[200px] text-slate-50">{list[position]}</div>
